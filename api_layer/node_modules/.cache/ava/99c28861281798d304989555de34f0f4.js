...
_ava2.default.serial('Should be able to start match', async t => {
    ...
    await request(server).put('/Match/' + t.context.matches[0]._id + '/' + t.context.matches[0]._status).expect(204).catch(err => t.fail(err));
    t.pass();
});
//# sourceMappingURL=../../../node_modules/.cache/ava/99c28861281798d304989555de34f0f4.js.map