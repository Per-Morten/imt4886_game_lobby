...
_ava2.default.serial('Should be able to start match', async t => {
    ...
    await request(server).put('/match/' + '111111111111111111111111' + '/' + 1).expect(404).then(response => t.pass()).catch(err => t.fail(err));

    t.pass();
});
//# sourceMappingURL=../../../node_modules/.cache/ava/008765cd0bfe10d1650376a71d623e3a.js.map