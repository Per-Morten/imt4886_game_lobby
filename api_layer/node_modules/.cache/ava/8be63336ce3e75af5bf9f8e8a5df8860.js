...
_ava2.default.serial('Should be able to start match', async t => {
    ...
    await request(server).put('/Match/' + t.context.matches[0]._id + '/' + t.context.matches[0].status).expect(204).catch(err => t.fail(err));
    t.pass();
});
//# sourceMappingURL=../../../node_modules/.cache/ava/8be63336ce3e75af5bf9f8e8a5df8860.js.map